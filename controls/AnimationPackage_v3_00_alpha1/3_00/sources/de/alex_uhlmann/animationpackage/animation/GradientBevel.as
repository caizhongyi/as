...
public class GradientBevel extends Filter implements IMultiAnimatable {
	...
	public function GradientBevel(...arguments:Array) {
	...
	override public function setStartValues(startValues:Array, optional:Boolean = false):Boolean {
		...
		if(startValues[0] is GradientBevelFilter) {			
	...
	override public function setEndValues(endValues:Array):Boolean {
		...
		if(endValues[0] is GradientBevelFilter) {
	...
	private function isFilterOfCorrectType(filter:BitmapFilter):Boolean {
		return (filter is GradientBevelFilter == true);
	}
	...
	private function createEmptyFilter():GradientBevelFilter {
