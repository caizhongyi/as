                ...
                if (_loc_3.namespace().prefix == MediaParser.PREFIX)
                {
                    switch(_loc_3.localName().toLowerCase())
                    {
                        case "content":
                        {
                            ...
                            if (_loc_3.@width && _loc_3.@bitrate)
                            {
                                if (!param2.levels)
                                {
                                    param2.levels = new Array();
                                }
                                param2.levels.push({width:_loc_3.@width.toString(), bitrate:_loc_3.@bitrate.toString(), url:_loc_3.@url.toString()});
                            }
                            break;
                        }
                        case "title":
